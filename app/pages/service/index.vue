      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <aside class="space-y-6 lg:col-span-1">
          ...
          <div class="bg-gradient-to-br from-indigo-900 to-neutral-900 p-6 rounded-2xl border border-indigo-800/50">
            ...
            <NuxtLink to="/contact" class="block w-full text-center rounded-xl bg-indigo-500 px-4 py-3 text-sm font-bold text-white hover:bg-indigo-400 transition"> Contact Us </NuxtLink>
          </div>
        </aside>
      </div>
    </div>
